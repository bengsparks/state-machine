...
auto main(int argc, char* argv[]) -> int {
    auto transitions = sm_ns::transitions{
        ...
        sm_ns::make_transition("paused", "running", "run", []() -> void {
                std::cout << "paused -> running : run\n";
        }),

        sm_ns::make_transition("running", "stopped", "stop", []() -> void {
                std::cout << "running -> stopped : stop\n";
        }),
        sm_ns::make_transition("paused", "stopped", "stop", []() -> void {
                std::cout << "paused -> stopped : stop\n";
        }),
